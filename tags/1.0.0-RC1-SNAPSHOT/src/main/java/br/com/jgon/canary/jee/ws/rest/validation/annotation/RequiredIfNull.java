...
/**
 * Esta anotação exige que o parâmetro seja válido caso o outro parãmetro citado seja nulo ou vazio.
 * 
 ...
 * No caso acima, o parâmetro "bar" será obrigatório caso o parâmetro "foo" for nulo ou vazio
 */
