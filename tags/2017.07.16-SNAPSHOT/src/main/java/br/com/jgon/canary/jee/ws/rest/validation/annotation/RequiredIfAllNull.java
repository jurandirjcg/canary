...
/**
 * Esta anotação exige que o parâmetro seja válido caso todos os outros parãmetros citados sejam nulos ou vazios.
 * @author alexandre
 ...
 * No caso acima, o parâmetro "bar" será obrigatório caso o parâmetro "foo" e o parâmetro "foo2" forem nulos ou vazios
 */
@Target(ElementType.PARAMETER)
@Retention(RetentionPolicy.RUNTIME)
@Documented
public @interface RequiredIfAllNull {
	String[] value();
}
