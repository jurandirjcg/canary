 ...
 * @param <T> Entity
 */
public interface CriteriaFilterUpdate<T> extends CriteriaWhere<T>, CriteriaWhereMetamodel<T> {
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhere(Attribute<T, ?> attribute, Predicate value);

    @Override
    public CriteriaFilterUpdate<T> addWhere(ComplexAttribute attribute, Predicate value);

    @Override
    public <E> CriteriaFilterUpdate<T> addWhereIn(String field, List<E> values);

    @Override
    public CriteriaFilterUpdate<T> addWhereILike(Attribute<T, String> attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereILike(ComplexAttribute attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereILike(Attribute<T, String> attribute,
            MatchMode matchMode);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereNotILike(Attribute<T, String> attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotILike(ComplexAttribute attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotLike(Attribute<T, String> attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotLike(ComplexAttribute attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereLike(Attribute<T, String> attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereLike(ComplexAttribute attribute, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotILike(Attribute<T, String> attribute,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotILike(ComplexAttribute attribute,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotLike(Attribute<T, String> attribute,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotLike(ComplexAttribute attribute,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereLike(Attribute<T, String> attribute,
            MatchMode matchMode);
    ...
    @Override
    public <E> CriteriaFilterUpdate<T> addWhereNotEqual(Attribute<T, E> attribute,
            List<E> values);

    @Override
    public <E> CriteriaFilterUpdate<T> addWhereNotEqual(ComplexAttribute attribute,
            List<E> values);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(Attribute<T, Integer> attribute,
            Integer startValue, Integer endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(ComplexAttribute attribute, Integer startValue,
            Integer endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(Attribute<T, Short> attribute,
            Short startValue, Short endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(ComplexAttribute attribute, Short startValue,
            Short endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(Attribute<T, Long> attribute, Long startValue,
            Long endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(ComplexAttribute attribute, Long startValue,
            Long endValue);

    @Override
    public <E> CriteriaFilterUpdate<T> addWhereLessThanField(Attribute<T, E> attribute,
            Attribute<T, E> anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereLessThanField(ComplexAttribute attribute,
    ...
    @Override
    public <E> CriteriaFilterUpdate<T> addWhereGreaterThanField(Attribute<T, E> attribute,
            Attribute<T, E> anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereGreaterThanField(ComplexAttribute attribute,
            Attribute<T, ?> anotherAttribute);
    ...
    @Override
    public <E> CriteriaFilterUpdate<T> addWhereLessThanOrEqualToField(Attribute<T, E> attribute,
            Attribute<T, E> anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereLessThanOrEqualToField(ComplexAttribute attribute,
            Attribute<T, ?> anotherAttribute);
    ...
    @Override
    public <E> CriteriaFilterUpdate<T> addWhereGreaterThanOrEqualToField(
            Attribute<T, E> attribute, Attribute<T, E> anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereGreaterThanOrEqualToField(ComplexAttribute attribute,
            Attribute<T, ?> anotherAttribute);
    ...
    @Override
    public <E> CriteriaFilterUpdate<T> addWhereEqualField(Attribute<T, E> attribute,
            Attribute<T, E> anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereEqualField(ComplexAttribute attribute,
            Attribute<T, ?> anotherAttribute);
    ...
    @Override
    public <E> CriteriaFilterUpdate<T> addWhereNotEqualField(Attribute<T, E> attribute,
            Attribute<T, E> anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotEqualField(ComplexAttribute attribute,
            Attribute<T, ?> anotherAttribute);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(Attribute<T, Date> attribute, Date startValue,
            Date endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(ComplexAttribute attribute, Date startValue,
            Date endValue);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereGreaterThanOrEqualTo(Attribute<T, Date> attribute,
            Date value);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereLessThanOrEqualTo(Attribute<T, Date> attribute,
            Date value);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereRegex(Attribute<T, ?> attribute, String value,
    RegexWhere[] regexToAnalyse, RegexWhere defaultIfNotMatch)
    throws ApplicationRuntimeException;

    @Override
    public CriteriaFilterUpdate<T> addWhereRegex(ComplexAttribute attribute, String value,
            RegexWhere[] regexToAnalyse, RegexWhere defaultIfNotMatch)
            throws ApplicationRuntimeException;

    @Override
    public CriteriaFilterUpdate<T> addWhereNotEqualField(Attribute<T, ?> attribute,
            ComplexAttribute anotherAttribute);

    @Override
    public CriteriaFilterUpdate<T> addWhereEqualField(Attribute<T, ?> attribute,
            ComplexAttribute anotherAttribute);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(String field, Integer startValue,
            Integer endValue);

    @Override
    public CriteriaFilterUpdate<T> addWhereBetween(String field, Short startValue,
            Short endValue);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereLessThanOrEqualToField(String field,
            String anotherField);

    @Override
    public CriteriaFilterUpdate<T> addWhereGreaterThanOrEqualToField(String field,
            String anotherField);
    ...
    @Override
    public CriteriaFilterUpdate<T> addWhereNotLike(String field, String value,
            MatchMode matchMode);

    @Override
    public CriteriaFilterUpdate<T> addWhereNotILike(String field, String value,
            MatchMode matchMode);
