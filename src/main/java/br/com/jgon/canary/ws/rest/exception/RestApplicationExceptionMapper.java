 ...
 */
@Provider
public class RestApplicationExceptionMapper implements ExceptionMapper<ApplicationException>{

	private Logger LOG = Logger.getLogger(RestApplicationExceptionMapper.class.getName());
