...
import br.com.jgon.canary.ws.rest.validation.annotation.Required;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredDateGt;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredDateLt;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredIfAllNotNull;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredIfAllNull;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredIfAnyNotNull;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredIfAnyNull;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredIfNotNull;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredIfNull;
import br.com.jgon.canary.ws.rest.validation.annotation.RequiredRegExPattern;
...
public class RestValidationParameterFilter implements ContainerRequestFilter{
	...
	private Logger logger = LoggerFactory.getLogger(RestValidationParameterFilter.class);
