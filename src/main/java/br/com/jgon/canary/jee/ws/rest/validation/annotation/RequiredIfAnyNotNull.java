...
/**
 * Esta anotação exige que o parâmetro seja válido caso algum dos outros parãmetros citados seja fornecido.
 * 
 ...
 * No caso acima, o parâmetro "bar" será obrigatório caso o parâmetro "foo" ou o parâmetro "foo2" for fornecido
 */
@Target(ElementType.PARAMETER)
@Retention(RetentionPolicy.RUNTIME)
@Documented
public @interface RequiredIfAnyNotNull {
	String[] value();
}
