...
public class ValidatorFactory {
    ...
    public ValidatorFactory requiredIfAnyNull(Object value, String valueName, Collection<SimpleEntry<String, Object>> testValue) {
        ...
        if (!fieldNames.isEmpty()) {
            validatorException.add(new ValidateMessage(MessageSeverity.WARN, REQUIRED_IF_ANY_NULL_KEY, valueName,
                montaListaParametrosStringException(fieldNames, "e")));
        }
        return this;
    }
    ...
    public ValidatorFactory requiredIfAllNull(Object value, String valueName, Collection<SimpleEntry<String, Object>> testValue) {
        ...
        if (!fieldNames.isEmpty()) {
            validatorException.add(new ValidateMessage(MessageSeverity.WARN, REQUIRED_IF_ALL_NULL_KEY, valueName,
                montaListaParametrosStringException(fieldNames, "e")));
        }
        return this;
    }
    ...
    public ValidatorFactory requiredIfAllNotNull(Object value, String valueName, Collection<SimpleEntry<String, Object>> testValue) {
        ...
        if (!fieldNames.isEmpty()) {
            validatorException.add(new ValidateMessage(MessageSeverity.WARN, REQUIRED_IF_ALL_NOT_NULL_KEY, valueName,
                montaListaParametrosStringException(fieldNames, "e")));
        }
        return this;
    }
    ...
    public ValidatorFactory requiredIfAnyNotNull(Object value, String valueName, Collection<SimpleEntry<String, Object>> testValue) {
        ...
        if ((paramNull.isEmpty() && paramNotNull.isEmpty()) || paramNotNull.size() > 1) {
            validatorException.add(
                new ValidateMessage(MessageSeverity.WARN, REQUIRED_XOR_KEY, valueName, montaListaParametrosStringException(paramNames, "e"),
                    montaListaParametrosStringException(paramNotNull, "e"), montaListaParametrosStringException(paramNull, "e")));
        }
        return this;
    }
    ...
    public ValidatorFactory requiredXOR(Object value, String valueName, Collection<SimpleEntry<String, Object>> testValue) {
        ...
        if (!fieldNames.isEmpty()) {
            validatorException.add(new ValidateMessage(MessageSeverity.WARN, REQUIRED_IF_ANY_NOT_NULL_KEY, valueName,
                montaListaParametrosStringException(fieldNames, "e")));
        }
        return this;
    }
    ...
    public ValidatorFactory lessThanOrGreaterThan(Number valor, Number min, Number max, String campoMsg) {
        if (valor.doubleValue() > min.doubleValue() || valor.doubleValue() < max.doubleValue()) {
            validatorException
                .add(new ValidateMessage(MessageSeverity.WARN, LESS_THAN_OR_GREATER_THAN_KEY, campoMsg, min.toString(), max.toString()));
        }
        return this;
    }
    ...
    public static String montaListaParametrosStringException(List<String> parametros, String ultimoDivisorParametros) {
        ...
        if (parametros != null && parametros.size() > 0) {
            ...
            if (tamanho > 1) {
                // Monta ate o penultimo parametro para permitir adicionar o divisor do ultimo
                // parametro ('e', 'ou', etc)
                for (; i < tamanho - 1; i++) {
